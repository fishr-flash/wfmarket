package su.fishr.market.service.bayer 
{
	...
	public class PrebuyRequest 
	{
        ...
        public function PrebuyRequest( entity_id:int, type:String, callback:Function  ) {
			
			_call = callback;
            loader = new URLLoader();
            configureListeners(loader);

            var request:URLRequest = new URLRequest("https://wf.mail.ru/minigames/marketplace/api/info?type=" + type + "&entity_id=" + entity_id );
